...
generateOrientationBefore('#orientationviz1L',newData,5,9,1);
newData = sortByAlpha(byIncomeGroup(data,2),'country name');
generateOrientationBefore('#orientationviz1LM',newData,5,9,1);
newData = sortByAlpha(byIncomeGroup(data,3),'country name');
generateOrientationBefore('#orientationviz1UM',newData,5,9,1);
newData = sortByAlpha(byIncomeGroup(data,4),'country name');
generateOrientationBefore('#orientationviz1H',newData,5,9,1);

newData = sortByAlpha(byIncomeGroup(data,1),'country name');
generateOrientationBefore('#orientationviz2L',newData,5,9,2);
newData = sortByAlpha(byIncomeGroup(data,2),'country name');
generateOrientationBefore('#orientationviz2LM',newData,5,9,2);
newData = sortByAlpha(byIncomeGroup(data,3),'country name');
generateOrientationBefore('#orientationviz2UM',newData,5,9,2);
newData = sortByAlpha(byIncomeGroup(data,4),'country name');
generateOrientationBefore('#orientationviz2H',newData,5,9,2);

newData = sortByAlpha(byIncomeGroup(data,1),'country name');
generateOrientationBefore('#orientationviz3L',newData,5,9,3);
newData = sortByAlpha(byIncomeGroup(data,2),'country name');
generateOrientationBefore('#orientationviz3LM',newData,5,9,3);
newData = sortByAlpha(byIncomeGroup(data,3),'country name');
generateOrientationBefore('#orientationviz3UM',newData,5,9,3);
newData = sortByAlpha(byIncomeGroup(data,4),'country name');
generateOrientationBefore('#orientationviz3H',newData,5,9,3);

newData = sortByAlpha(byIncomeGroup(data,1),'country name');
generateOrientationAfter('#orientationviz4L',newData,5,9,3,false);
newData = sortByAlpha(byIncomeGroup(data,2),'country name');
generateOrientationAfter('#orientationviz4LM',newData,5,9,3,false);
newData = sortByAlpha(byIncomeGroup(data,3),'country name');
generateOrientationAfter('#orientationviz4UM',newData,5,9,3,false);
newData = sortByAlpha(byIncomeGroup(data,4),'country name');
generateOrientationAfter('#orientationviz4H',newData,5,9,3,false);

generateOrientationAfter('#orientationviz6',religionData,3,2,1,true);

let wPlot = $('#orientationviz5').width();
let hPlot = $('#orientationviz5').width();
scatterplot('#orientationviz5',data,'Q22','Q30-Religion','xtitle','ytitle','WBI',wPlot,hPlot,0,50,0,50);
...
function generateOrientationBefore(id,data,columns,rows,state){
    ...
    if(state==2){
        ...
        .enter().append("circle")
          ...
          .attr("cx",function(d,i) { return Math.floor(i / rows) * scale + scale*0.5 })
          .attr("cy",function(d,i) { return (i % rows)*scale + scale*0.5; })
          .attr("r", function(d){ return scale/75*Math.sqrt(d['subBagree']*100) })
          .attr("fill",'red');
        ...
        .enter().append("circle")
          ...
          .attr("cx",function(d,i) { return Math.floor(i / rows) * scale + scale*0.2 })
          .attr("cy",function(d,i) { return (i % rows)*scale + scale*0.5; })
          .attr("r", function(d){ return scale/75*Math.sqrt(d['subAagree']*100) })
          .attr("fill",'red');*/
